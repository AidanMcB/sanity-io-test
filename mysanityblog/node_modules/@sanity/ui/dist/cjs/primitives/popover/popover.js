...
var import_arrow = __toModule(require("./arrow"));
var import_modifiers = __toModule(require("./modifiers"));
...
const Popover = (0, import_react.forwardRef)((props, ref) => {
  ...
  const modifiers = (0, import_modifiers.usePopoverModifiers)({
    allowedAutoPlacements,
    arrow,
    arrowElement,
  ...
  const popoverStyle = __objSpread(__objSpread({}, style), styles.popper);
  const node = /* @__PURE__ */ import_react.default.createElement(Root, __objSpread(__objSpread(__objSpread({
    "data-ui": "Popover"
  }, restProps), {
    ...
    tone,
    width
  }, arrow && /* @__PURE__ */ import_react.default.createElement(import_arrow.PopoverArrow, {
    ref: setArrowElement,
    style: styles.arrow
  }), content));
