...
const Root = import_styled_components.default.div`
  position: relative;
`;
const ListBox = (0, import_styled_components.default)(import_primitives.Box)`
  & > ul {
    list-style: none;
    padding: 0;
    margin: 0;
...
`;
const ResultsPopover = (0, import_styled_components.default)(import_primitives.Popover)`
  & > div {
    min-height: 43px;
    overflow: auto;
...
`;
const LoadingCard = (0, import_styled_components.default)(import_primitives.Card)`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
const InnerAutocomplete = (0, import_react.forwardRef)((props, ref) => {
  const _a = props, {
    border = true,
    customValidity,
    disabled,
  ...
  const [value, setValue] = (0, import_react.useState)(valueProp);
  ...
  const resultsPopoverRef = (0, import_react.useRef)(null);
  ...
  const handleRootBlur = (0, import_react.useCallback)(() => {
    setTimeout(() => {
      ...
      const focusInside = focusedEl && (rootEl && rootEl.contains(focusedEl) || resultsPopoverEl && resultsPopoverEl.contains(focusedEl));
      if (!focusInside) {
        setFocused(false);
        setQuery(null);
        if (onQueryChange)
  ...
  const handleInputFocus = (0, import_react.useCallback)(() => setFocused(true), []);
  ...
  const handleClearButtonFocus = (0, import_react.useCallback)(() => setFocused(true), []);
  ...
  (0, import_react.useEffect)(() => setSelectedIndex(-1), [optionsLen]);
  (0, import_react.useEffect)(() => {
    ...
    if (selectedItemElement) {
      (0, import_helpers.focusFirstDescendant)(selectedItemElement);
    }
  }, [selectedIndex]);
  ...
  const clearButton = (0, import_react.useMemo)(() => !disabled && value.length > 0 ? {
    "aria-label": "Clear",
  ...
  const openButtonProps = (0, import_react.useMemo)(() => typeof openButton === "object" ? openButton : EMPTY_RECORD, [openButton]);
  ...
  const openButtonNode = (0, import_react.useMemo)(() => openButton ? /* @__PURE__ */ import_react.default.createElement(import_primitives.Box, {
    padding: openButtonBoxPadding
  }, /* @__PURE__ */ import_react.default.createElement(import_primitives.Button, __objSpread(__objSpread({}, openButtonProps), {
    fontSize,
  ...
  return /* @__PURE__ */ import_react.default.createElement(Root, {
    ...
    ref: rootRef
  }, /* @__PURE__ */ import_react.default.createElement(ResultsPopover, {
    arrow: false,
    constrainSize: true,
    content: /* @__PURE__ */ import_react.default.createElement(ListBox, {
      paddingY: 1,
      tabIndex: -1
      ...
      ref: listRef,
      role: "listbox"
    }, filteredOptions.map((option, optionIndex) => /* @__PURE__ */ import_react.default.createElement(import_autocompleteOption.AutocompleteOption, {
      id: `${id}-option-${optionIndex}`,
      key: option.value,
      onSelect: handleOptionSelect,
      selected: selectedIndex > -1 ? optionIndex === selectedIndex : currentOption === option,
      value: option.value
    }, (0, import_react.cloneElement)(renderOption(option), {disabled: loading, tabIndex: -1})))), /* @__PURE__ */ import_react.default.createElement(LoadingCard, {
      padding: 3,
      style: {opacity: loading ? 0.5 : 0}
    }, /* @__PURE__ */ import_react.default.createElement(import_primitives.Spinner, null))),
  ...
  }, /* @__PURE__ */ import_react.default.createElement(import_primitives.TextInput, __objSpread(__objSpread({}, restProps), {
