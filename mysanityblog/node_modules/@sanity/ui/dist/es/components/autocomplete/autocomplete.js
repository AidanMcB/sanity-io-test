...
import {Box, Button, Card, Popover, Spinner, Text, TextInput} from "../../primitives";
...
const InnerAutocomplete = forwardRef((props, ref) => {
  ...
  const resultsPopoverRef = useRef(null);
  ...
  }, /* @__PURE__ */ React.createElement(Button, __objSpread(__objSpread({}, openButtonProps), {
    fontSize,
  ...
  return /* @__PURE__ */ React.createElement(Root, {
    ...
    ref: rootRef
  }, /* @__PURE__ */ React.createElement(ResultsPopover, {
    arrow: false,
    constrainSize: true,
  ...
  }, /* @__PURE__ */ React.createElement(TextInput, __objSpread(__objSpread({}, restProps), {
